...
export default function GitHubReplay() {
  ...
  const REPLAY_SLIDES = [
    ...
    },
    {
      icon: '🔥',
      label: 'Activity Rate',
      value: gh.loading ? '...' : `${gh.activePercent}%`,
    ...
    },
    {
      icon: '💻',
      label: 'Top Language',
      value: gh.topLanguages[0]?.name ?? 'TypeScript',
      subtitle: `${gh.topLanguages[0]?.percent ?? '...'}% of your codebase.`,
      color: '#3b82f6',
    },
    {
      icon: '🎯',
      label: 'Years of Experience',
      value: `${gh.yearsOfExperience}+`,
